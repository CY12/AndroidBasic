...
public final class SpanUtils {
    ...
    public static class SpanBuilder {
        ...
        public SpanBuilder addForeColorSection(String section, String color) {
            return addCertainSection(section, new ForegroundColorSpan(Color.parseColor(color)), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
