...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property SNode = new Property(1, String.class, "sNode", false, "S_NODE");
    ...
    protected final void bindValues(DatabaseStatement stmt, Student entity) {
        ...
        String sNode = entity.getSNode();
        if (sNode != null) {
            stmt.bindString(2, sNode);
        }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // sNode
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setSNode(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
