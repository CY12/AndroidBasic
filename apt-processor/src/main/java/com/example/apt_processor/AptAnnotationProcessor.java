...
public class AptAnnotationProcessor extends AbstractProcessor {
    ...
    public synchronized void init(ProcessingEnvironment processingEnvironment) {
        ...
        System.out.println("AptAnnotationProcessor init");
    }
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        messager.printMessage(Diagnostic.Kind.NOTE,"AptAnnotationProcessor start process");
        ...
        // 指定包路径，构建文件体
        JavaFile javaFile = JavaFile.builder("com.example.space", helloWorld).build();
        try {
            // 创建文件
